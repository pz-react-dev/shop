    ...
    <div class="col-md-8">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-6">Edycja produktu</div>
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('products.update',$product->id) }}" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <input id="amount" type="number" step="1" min="0" class="form-control @error('amount') is-invalid @enderror" name="amount" value="{{ $product->amount }}" required autocomplete="amount" autofocus>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <input id="unit" type="text" class="form-control @error('unit') is-invalid @enderror" name="unit" value="{{ $product->unit }}" required autocomplete="unit" autofocus>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <select id="category_id" type="text" class="form-select @error('category_id') is-invalid @enderror" name="category_id" value="{{ old('category_id') }}" autofocus>
            ...
            <div class="row mb-0">
              <div class="col-md-6 offset-md-4">
                ...
                <button type="submit" class="btn btn-primary" formaction="{{route('products.store')}}">
                  {{ 'Kopiuj' }}
                </button>
              </div>
            </div>
